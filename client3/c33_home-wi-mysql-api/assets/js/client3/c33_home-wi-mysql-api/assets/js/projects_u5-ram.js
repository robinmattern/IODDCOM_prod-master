...
if (aTests.match( /test2/ ) ) { 
  ...
  async function fetchProjects() { 
       ...
       var  mProjects     = (await fetchJSON( 'http://localhost:3000/projects?recs=2'      )).Projects
...
//---------------------------------------------------------------------------------------------------
  ...
  async  function  fmtProjects( pJSON ) {     
...
//     ---  -------  =  -----------------------------------
  ...
  async  function  fmtProject( pProject, i ) {
...
//---------------------------------------------------------------------------------------------------
  ...
  function  fmtProject1( pProject, i ) {
       ...
       var  aColaborator = `${mNames[0].FirstName} ${mNames[0].LastName}`
