...
//          ---------------------------------------------------
  ...
  function  fmtRoot( aName ) {
       var  aHTML = `
                ...
                Use any of the following APIs:<br><br><br>
                <div style="margin-left:40px; font-size:20px;">
                <a href="/login?id=90"                  >/login</a><br><br>
                <a href="/meetings"                     >/meetings</a><br><br>
                <a href="/members"                      >/members</a><br><br>
                <a href="/members_bios"                 >/members_bios</a><br><br>
                <a href="/members_projects"             >/members_projects</a><br><br>
...
this.getUser = function( ) {
  ...
  var  aRoute = `${aAPI_Host}/user`

  pApp.get( aRoute, async ( pReq, pRes ) => onGetRoute( pReq, pRes, '/user', { id: /[0-9]+/ }, fmtSQL ) )
       sayMsg( 'get', aRoute )
